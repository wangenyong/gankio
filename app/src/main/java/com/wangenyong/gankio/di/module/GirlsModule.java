...
import com.wangenyong.gankio.model.GirlsModel;
import com.wangenyong.gankio.presentation.girls.GirlsContract;
...
public class GirlsModule {
    ...
    @ActivityScope
    @Provides
    GirlsContract.View provideGirlsView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    GirlsContract.Model provideGirlsModel(GirlsModel model) {
        return model;
    }
}